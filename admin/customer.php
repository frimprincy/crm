...
<nav class="navbar navbar-expand-lg sticky-top">
    ...
    <div class="row">
        ...
        if(isset($_SESSION["admin_email"])){
                 echo "<span style='color:green'>welcome:</span>".$_SESSION['admin_email'] ;
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <form class="form-inline"  method="post" name='RegForm' onsubmit="return GEEKFORGEEKS()">
                    ...
                    <div class="modal-dialog" role="document">
                      ...
                      <form method="post" name='RegForm' onsubmit="return GEEKFORGEEKS()" >  
                        <div class="modal-body">
                            ...
                            <hr>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                    <input type="text" class="form-control" name="phone"  placeholder="0501 431 357" required>
                                    </div>
                                </div>
                                <br>
                                <div class="form-row">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="customers" class="btn btn-primary">Save changes</button>
