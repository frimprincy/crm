                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <form method="post" class="mt-5">
                                <!--  name and category -->
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <input type="text" name='itemName' class="form-control" placeholder="Name">
                                        </div>
                                        <div class="col">
                                        <input type="text" class="form-control" name='itemCat' placeholder="Category">
                                        </div>
                                    </div>
                                ...
                                <hr>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <input type="text" class="form-control" name='itemAmount'  placeholder="Amount">
                                        </div>
                                        <div class="col">
                            ...
                            <div class="modal-footer">
                                <button type="submit" name='sales' class="btn btn-primary">Save changes</button>
...
{ 
    ...
    var productCat = document.forms["RegForm"]["itemCat"];    
    var productID = document.forms["RegForm"]["ItemID"];  
    var productAmount =  document.forms["RegForm"]["itemAmount"];  
    var productQuantity = document.forms["RegForm"]["itemQuantity"];  
     ...
     if (/^[A-Za-z]+$/g.test(productID.value)) {
        alert("sale Id accepts only letters");
        productID.focus();
        return false;
    }

     if (/^[A-Za-z]+$/g.test(productAmount.value)) {
        alert("item Amount accepts only letters");
        productAmount.focus();
        return false;
    }
