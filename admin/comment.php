                            ...
                            <div class="modal-body">
                                <form class="mb-5" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="commentName" style="width:100%;" class="form-control" id="blog-title" aria-describedby="blogtitle" placeholder="Enter Name..." required>
                                        <small id="emailHelp" class="form-text text-muted">Name of the person who gave the comment</small>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Description: </label>
                                        <textarea class="form-control" name="commentDescription" style="width:100%;" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                    </div>
                                    <br>
...
{ 
    var name = document.forms["RegForm"]["commentName"];               
